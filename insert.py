...
print("<input type='text' class='form-control' name='ProductName'>")
print("</div>")
print("</div>")
...
print("<select class='custom-select mr-sm-2' id='inlineFormCustomSelect' name='SupplierID'><option selected>Choose...</option>")
for row in curr:
...
curr.execute(sql_command)
print("<select class='custom-select mr-sm-2' id='inlineFormCustomSelect' name='CategoryID'><option selected>Choose...</option>")
for row in curr:
...
print("</div>")
print("<div class='col-2'>")
print("<input type='text' class='form-control' name='QuantityPerUnit'>")
print("</div>")
print("</div>")
...
print("<input type='text' class='form-control' name='UnitPrice'>")
...
print("</div>")
print("<div class='col-2'>")
print("<input type='text' class='form-control' name='UnitsInStock'>")
print("</div>")
print("</div>")
...
print("</div>")
print("<div class='col-2'>")
print("<input type='text' class='form-control' name='UnitsOnOrder'>")
print("</div>")
print("</div>")
...
print("</div>")
print("<div class='col-2'>")
print("<input class='form-check-input' value='0' type='checkbox' id='Discontinued' name='Discontinued'>")
print("</div>")
print("</div>")
